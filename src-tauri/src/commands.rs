...
fn build_settings_payload(
    ...
    Ok(SettingsPayload {
        ...
        github_related_updates_only: config.github_related_updates_only,
...
pub fn get_review_dump(state: State<'_, AppState>) -> Result<ReviewDump, String> {
    ...
    state
        ...
        .dump(
            ...
            done_menu_limit.github_related_updates_only,
...
pub fn save_settings(
    ...
    let config = AppConfig {
        ...
        github_related_updates_only: payload.github_related_updates_only,
